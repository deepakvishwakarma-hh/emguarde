...
const Hero = () => {
  return (
    <section className="border-2-- bg-gray-50 py-10">
      <div className="mx-auto max-w-2xl grid gap-10 py-5">
        ...
        <Link
          href={"#buy-section"}
          className=" font-semibold bg-yellow-400 px-10 py-2 rounded-full mx-auto block   outline-yellow-400 outline outline-offset-1"
        >
          Buy Now
        </Link>
      </div>
